        ...
        dialog = {
            ...
            show: function() {
                ...
                onAnimationEnd(self.el, function() {
                    removeClasses(self.el, [ "sidler-hide", "sidler-hiding", "sidler-showing" ]);
                    return self.el.classList.add("sidler-show");
                });
                if (modal) {
                    makeModal();
                }
                return self.el.classList.add("sidler-showing");
            },
            hide: function() {
                var self = this;
                onAnimationEnd(self.el, function() {
                    removeClasses(self.el, [ "sidler-show", "sidler-showing", "sidler-hiding" ]);
                    return self.el.classList.add("sidler-hide");
                });
